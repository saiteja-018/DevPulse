      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-2xl">
          ...
          <form action={async () => {
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 bg-gray-800 hover:bg-gray-700 border border-gray-700 text-white font-medium py-3 px-4 rounded-xl transition-colors mb-6"
            >
          ...
          <form action={async (formData) => {
            ...
            try {
              ...
              // In Next.js, signIn throws a RedirectError if successful, which should be thrown.
              // Other errors can be ignored or handled
              throw error
            }
          }} className="space-y-4">
            <div>
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-semibold py-3 px-4 rounded-xl transition-all shadow-lg shadow-indigo-500/25"
            >
              Sign in
            </button>
          </form>
